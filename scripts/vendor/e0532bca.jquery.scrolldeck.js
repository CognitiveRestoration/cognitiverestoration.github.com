...
(function($) {
    $.scrolldeck = function(options) {
		...
		var init = function() {
			...
			// custom change height of images
			for (i=0; i<$('.resize-height').length; i++) {
				anim = $('img.resize-height').eq(i);
				anim.css('height', '' + windowHeight + 'px;');
			}
			...
			for (i=0; i<$('.animate-in').length; i++) {
				...
				switch (anim.attr('data-animation')) {
					...
					case 'fade-in':
						...
						break;
					case 'fade-in-0-then-out':
						scrolldeck.controller.animate(anim, { delay: 0, duration: windowHeight/4, property:'opacity', start:0, end:1, pin:true });
						// scrolldeck.controller.animate(anim, { delay: windowHeight, duration: windowHeight/2, property:'opacity', start:1, end:0 });
						break;
					case 'fade-in-1a-then-out':
						scrolldeck.controller.animate(anim, { delay: windowHeight/4, duration: windowHeight, property:'opacity', start:0, end:1, pin:true });
						// scrolldeck.controller.animate(anim, { delay: windowHeight, duration: windowHeight/2, property:'opacity', start:1, end:0 });
						break;
					case 'fade-in-1b-then-out':
						scrolldeck.controller.animate(anim, { delay: windowHeight*1.25, duration: windowHeight, property:'opacity', start:0, end:1 });
						// scrolldeck.controller.animate(anim, { delay: windowHeight*3, duration: windowHeight, property:'opacity', start:1, end:0 });
						break;
					// case 'fade-in-1c-then-out':
					// 	scrolldeck.controller.animate(anim, { delay: windowHeight*3, duration: windowHeight, property:'opacity', start:0, end:1 });
					// 	scrolldeck.controller.animate(anim, { delay: windowHeight*3, duration: windowHeight, property:'opacity', start:1, end:0 });
					// 	break;
					case 'fade-in-1d':
						scrolldeck.controller.animate(anim, { delay: windowHeight*2.25, duration: windowHeight, property:'opacity', start:0, end:1, pin:true });
						break;
					case 'fade-in-1e':
						scrolldeck.controller.animate(anim, { delay: windowHeight*3.25, duration: windowHeight/10, property:'opacity', start:0, end:1, pin:true });
						break;

					case 'slide-it-up-1a':
					  scrolldeck.controller.animate(anim, { delay: windowHeight*1.5, duration: windowHeight, property:'top', start: windowHeight*2, end:0 });
					  break;

					case 'fade-out':
						scrolldeck.controller.animate(anim, { delay: 0, duration: windowHeight, property:'opacity', start:1, end:0, pin:true });
						break;


					case 'cover-up':
					  scrolldeck.controller.animate(anim, { delay: 0, duration: windowHeight, property:'top', start: windowHeight/2, end:-windowHeight*0.9 });
					  break;


					case 'unpin-it-1a':
					  scrolldeck.controller.animate(anim, { delay: windowHeight, duration: windowHeight, property:'top', start:windowHeight/2, end:-windowHeight*0.9, pin:true });
					  break;
					case 'unpin-it-1b':
					  scrolldeck.controller.animate(anim, { delay: windowHeight*1.2, duration: windowHeight, property:'top', start:windowHeight/2, end:-windowHeight*0.9, pin:true });
					  break;


					case 'unpin-it-2a':
					  scrolldeck.controller.animate(anim, { delay: 0, duration: windowHeight, property:'top', start:windowHeight, end:0, pin:true });
					  break;
					case 'unpin-it-2b':
					  scrolldeck.controller.animate(anim, { delay: windowHeight/3, duration: windowHeight, property:'top', start:windowHeight, end:0, pin:true });
					  break;
					...
					case 'unpin-it-3a':
					  ...
					  break;
					case 'unpin-it-3b':
					  scrolldeck.controller.animate(anim, { delay: windowHeight*0.75, duration: windowHeight, property:'top', start:windowHeight, end:0, pin:true });
					  break;
